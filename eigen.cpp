...
Eigen::SparseMatrix<double> EigenTest::ConvertMatrix(const std::vector<Eigen::Triplet<double> >& data, const COO& coo_data, bool reserve) {
  ...
  if(reserve){mat.reserve(Eigen::VectorXi::Constant(coo_data.num_cols,12));}
